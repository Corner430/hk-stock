...
| `STOP_LOSS_PCT` | 8% | 止损线 |
| `TAKE_PROFIT_PCT` | 25% | 全仓止盈线（达到即清仓） |
| `DRAWDOWN_WARN_PCT` | 5% | 组合回撤警告线 |
| `DRAWDOWN_HALT_PCT` | 8% | 组合回撤停买线 |
| `DRAWDOWN_REDUCE_PCT` | 12% | 组合回撤强制减仓线 |
| `TIME_STOP_DAYS` | 25 | 时间止损天数 |
| `ATR_RISK_PER_TRADE` | 2% | ATR 单笔风险比例 |
| `PARTIAL_BUILD_RATIOS` | 50/30/20 | 分批建仓比例 |
| `PARTIAL_TP_LEVELS` | 10%/18%/25% | 分批止盈档位 |
